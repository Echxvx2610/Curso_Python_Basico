...
#************************** Accesando y modificando elementos **************************
print("***************** Accesando y modificando elementos ******************")
fruits = ['banana', 'orange', 'mango', 'lemon'] 
first_fruit = fruits[0] # Podemos accesar a los elementos de una lista con su index
